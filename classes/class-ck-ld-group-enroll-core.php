...
class CK_LD_Group_Enroll_Core {
	 ...
	 * @throws Error - If asset file is missing.
	 */
	 ...
	 * @throws Error - Throws Error if the user_ids or Group ID are not valid.
	 */
	 ...
	 */
	public function logger( string $class_name, string $function_name, $data ) {
